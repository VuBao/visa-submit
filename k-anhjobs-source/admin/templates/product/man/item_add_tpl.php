		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php if(isset($config['product'][$type]['tile']) && $config['product'][$type]['tile'] == true) { ?>
						<div class="form-group col-md-4">
							<label class="d-block" for="tile">Tỉ lệ:</label>
							<input type="number" class="form-control" name="data[tile]" id="tile" placeholder="Tỉ lệ" value="<?=@$item['tile']?>">
						</div>
					<?php } ?>
