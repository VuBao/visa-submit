...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
		...
		<?php if(isset($config['website']['debug-developer']) && $config['website']['debug-developer'] == false) { ?>
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php if(isset($config['setting']['secret_google']) && $config['setting']['secret_google'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="secret_google">Secret google:</label>
							<input type="text" class="form-control" name="data[options][secret_google]" id="secret_google" placeholder="Secret google" value="<?=$options['secret_google']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['client_id_google']) && $config['setting']['client_id_google'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="client_id_google">Client id google:</label>
							<input type="text" class="form-control" name="data[options][client_id_google]" id="client_id_google" placeholder="Client id google" value="<?=$options['client_id_google']?>">
						</div>
					<?php } ?>

					<?php if(isset($config['setting']['secret_facebook']) && $config['setting']['secret_facebook'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="secret_facebook">Secret Facebook:</label>
							<input type="text" class="form-control" name="data[options][secret_facebook]" id="secret_facebook" placeholder="Secret Facebook" value="<?=$options['secret_facebook']?>">
						</div>
					<?php } ?>

					<?php if(isset($config['setting']['client_id_facebook']) && $config['setting']['client_id_facebook'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="client_id_facebook">Client id Facebook:</label>
							<input type="text" class="form-control" name="data[options][client_id_facebook]" id="client_id_facebook" placeholder="Client id Facebook" value="<?=$options['client_id_facebook']?>">
						</div>
					<?php } ?>
				</div>
