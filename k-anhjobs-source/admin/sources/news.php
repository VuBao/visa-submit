<?php
	...
	function save_item()
	{
		...
		if($data)
		{
			...
			if(isset($_POST['slugjp'])) $data['tenkhongdaujp'] = $func->changeTitle(htmlspecialchars($_POST['slugjp']));
			else $data['tenkhongdaujp'] = (isset($data['tenjp'])) ? $func->changeTitle($data['tenjp']) : '';
			...
			$data['handangtuyen'] = strtotime($data['handangtuyen']);
			$data['ngayvaolam'] = strtotime($data['ngayvaolam']);
			$data['hienthi'] = (isset($data['hienthi'])) ? 1 : 0;
			$data['tienthuong'] = (isset($data['tienthuong'])) ? 1 : 0;
			$data['1phong'] = (isset($data['1phong'])) ? 1 : 0;
			$data['lamthem'] = (isset($data['lamthem'])) ? 1 : 0;
			$data['trocap'] = (isset($data['trocap'])) ? 1 : 0;
			$data['tangluong'] = (isset($data['tangluong'])) ? 1 : 0;
			$data['trangthai'] = (isset($data['trangthai']) && $data['trangthai'] > 0) ? $data['trangthai'] : 1;
			$data['type'] = $type;
		}
