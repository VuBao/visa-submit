...
<head>
	...
	<link rel="icon" type="image/x-icon" href="assets/images/logo-admintrator.png">
	...
	<script type="text/javascript">
		CKEDITOR.editorConfig = function( config ) {
			...
			/* All Plugins */
			config.extraPlugins = 'syntaxhighlight,codesnippet,texttransform,copyformatting,html5video,html5audio,flash,youtube,wordcount,tableresize,widget,lineutils,clipboard,dialog,dialogui,widgetselection,lineheight,video,videodetector';
