...
$config['setting']['secret_google'] = true;
$config['setting']['client_id_google'] = true;
$config['setting']['secret_facebook'] = true;
$config['setting']['client_id_facebook'] = true;
