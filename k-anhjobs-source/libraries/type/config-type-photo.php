...
/* Banner auth */
$nametype = "banner-auth";
$config['photo']['photo_static'][$nametype]['title_main'] = "Banner login register";
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 1920;
$config['photo']['photo_static'][$nametype]['height'] = 820;
$config['photo']['photo_static'][$nametype]['thumb'] = '820x410x1';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
...
$config['photo']['man_photo'][$nametype]['width_photo'] = 2000;
...
/* Mạng xã hội */
$nametype = "mangxahoi";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Mạng xã hội gửi mail";
$config['photo']['man_photo'][$nametype]['number_photo'] = 5;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
...
$nametype = "tinh-thanh";
$config['search']['man_search'][$nametype]['title_main_search'] = "Tỉnh thành";
$config['search']['man_search'][$nametype]['number_search'] = 1;
$config['search']['man_search'][$nametype]['tieude_search'] = true;
