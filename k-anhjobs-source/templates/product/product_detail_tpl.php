<div class="w-clear box_product_detail">
    <div class="product_detail_top">
        <div class="left_product_detail_top">
            <section class="slider_detail_product">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider__image"><img onerror="this.src='<?=THUMBS?>/540x540x2/assets/images/noimage.png';" src="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$row_detail['photo']?>" alt="<?=$row_detail['ten']?>"/></div>
                                    </div>

                                    <?php foreach($hinhanhsp as $ha) { ?> 
                                        <div class="swiper-slide">
                                            <div class="slider__image"><img onerror="this.src='<?=THUMBS?>/540x540x2/assets/images/noimage.png';" src="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$ha['photo']?>" alt="<?=$row_detail['ten']?>" /></div>
                                        </div>
                                    <?php } ?>
                    ...
                    <div class="slider__images">
                        <div class="swiper-container">
                            <div class="swiper-wrapper" id="lightgallery">
                                <div class="swiper-slide">
                                    <div class="slider__image background-zoom" style="background-image: url(<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$row_detail['photo']?>)" onmousemove="zoom(event)"> <a class="zoom "  href="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$row_detail['photo']?>"> 
                                        <img onerror="this.src='<?=THUMBS?>/540x540x2/assets/images/noimage.png';" src="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$row_detail['photo']?>" alt="<?=$row_detail['ten']?>"/>
                                    </a></div>
                                </div>
                                <?php foreach($hinhanhsp as $hha ) { ?> 
                                    <div class="swiper-slide">
                                        <div class="slider__image background-zoom" style="background-image: url(<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$hha['photo']?>)" onmousemove="zoom(event)"> <a class="zoom"  href="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$hha['photo']?>"> 
                                            <img onerror="this.src='<?=THUMBS?>/540x540x2/assets/images/noimage.png';" src="<?=THUMBS?>/540x540x1/<?=UPLOAD_PRODUCT_L.$hha['photo']?>" alt="" />
                                        </a></div>
                                    </div>
                                <?php } ?>
                            </div>
        ...
        <div class="right_product_detail_top">
            <h1 class="title_product_detail"><?= $row_detail['ten'] ?></h1>
            <?php if (isset($row_detail['masp']) && $row_detail['masp'] != '') { ?>
                <li class="w-clear masp_product_detail">
            ...
            <?php } else { ?>
                <a href="" class="button-lien-he-product-detail">Liên hệ ngay</a>
            <?php } ?>
        </div>
    </div>
